...
include { MG-ASSEMBLER  } from './workflows/mg-assembler'
...
workflow NXFCSP_MG-ASSEMBLER {
    ...
    emit:
    multiqc_report = MG-ASSEMBLER.out.multiqc_report // channel: /path/to/multiqc_report.html
}
/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    RUN MAIN WORKFLOW
