...
process SPADES {
    ...
    def reads = yml ? "--dataset $yml" : "$illumina_reads $illumina_reads_unpaired $pacbio_reads $nanopore_reads"
    // assembly mode setting
    def mode_isolate = isolate ? "--isolate": ""
    def mode_metagenome = metagenome ? "--meta": ""
    def mode_single_cell = single_cell ? "--sc": ""
    def mode_rna = rna ? "--rna": ""
    def mode_rna_viral = rna_viral ? "--rnaviral": ""
    def mode_meta_viral = meta_viral ? "--metaviral": ""
    def mode_plasmid = plasmid ? "--plasmid": ""
    def mode_meta_plasmid = meta_plasmid ? "--metaplasmid": ""
